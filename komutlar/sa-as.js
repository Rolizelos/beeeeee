...
exports.run = async (bot, message, args) => {
  ...
  if (args[0] === 'aç') {
    ...
    message.channel.send(`:white_check_mark:  Artık bot Sa diyince As diyecek. Kapatmak için "\`b!sa-as kapat\`" yazmalısın.`)
  ...
  if (args[0] === 'kapat') {
    ...
    message.channel.send(`:no_entry:Artık biri sa diyince cevap vermeyecek.`)
